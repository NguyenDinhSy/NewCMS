...
<div id="main-content" class="site-main gray-bg clearfix no-padding">
                            ...
                            <div class="single-post">
                                ...
                                <article class="hentry">
                                    ...
                                    <div class="post-content-wrap">
                                        <h2 class="post-title">
                                            <span>
                                                <a href="page-blog-single.html"><?php echo $post_title ?></a>
                                            </span>
                                        </h2><!-- .post-title -->
                                            ...
                                            <div class="post-meta-content">
                                                <div class="post-meta-content-inner">
                                                    <span class="post-by-author item">
                                                        <span class="inner">By:
                                                            <a href="#" title="" rel="author"><?php echo $post_author ?></a>
                                                        </span>
                                                    </span>
                                        ...
                                        <div class="post-content post-excerpt">
                                            <p> <?php echo $post_keyword ?></p>

                                            <p><img src="admin/img_upload/<?php echo $image_details ?>" alt=""></p>

                                            <h4>Giải thích</h4>
                                            <img src="admin/img_upload/<?php echo $image_explain ?>" alt="">
