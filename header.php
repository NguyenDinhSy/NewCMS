                ...
                <header id="site-header" class="header-front-page style-1 dark-bg">
                    <div id="site-header-inner" class="boxed-5">
                        <div class="wrap-inner clearfix">
                            ...
                            <a class="login-register register" href="#" data-toggle="modal" data-target="#reg_form_model">
                                <span class="user-thumb">
                                    <!-- <img src="assets/imgs/" class="w__32" alt="Img"> -->
                                </span>
                                <span class="user-name"><span>Syne</span></span>
                            </a>

                            <nav id="main-nav" class="main-nav">
                                <ul id="menu-primary-menu" class="menu">
                                    <li class="menu-item menu-item-has-children"><a href="#">Trang chủ</a>
                                        <ul class="sub-menu">
                                    ...
                                    <li class="menu-item current-menu-item menu-item-has-children">
                                        <a href="#">Liên hệ</a>
                                        <ul class="sub-menu">
                                            <li class="menu-item"><a href="page-add-listing.html">Liên hệ 1</a></li>
                                            <li class="menu-item"><a href="page-dashboard.html">Liên hệ 2</a></li>
                                            <li class="menu-item"><a href="page-my-profile.html">Liên hệ 3</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </nav><!-- #main-nav -->
