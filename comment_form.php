			...
			echo "
                <div class='container'>
                    <div class='row'>
                        <div class='col-md-12''>
                            <div class='shadow'>
                                <h4 style='display:block;padding: 10px 0px 0px 15px;'>$comment_name</h4>  
                                <p style='display:block; background:#1C2340;color:#fff;padding-left:15px;'>$comment_text</p>
                            </div>              
                        </div>
                    </div>
                </div>
...
<div class="container py-5">
    <div class="row">
        <div class="col-md-12 text-center">
            <div class="widget widget_contact_form clearfix widget__center">
                ...
                <form method="post" action="blog-details.php?post=<?php echo $post_new_id; ?>" class="contact-form">
                    <span class="form-control-wrap your-name">
                        <input type="text" id="name" name="comment_name" placeholder="Your Name" required>
                    </span>
                    <span class="form-control-wrap your-email">
                        <input type="email" id="email" name="comment_email" placeholder="Your Email" required>
                    </span>
                    <span class="form-control-wrap your-message">
                        <textarea name="comment" cols="40" rows="10" placeholder="Your Comment" required></textarea>
                    </span>
